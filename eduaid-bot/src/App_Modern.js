...
function App() {
  ...
  const getCurrentPageDescription = () => {
    const currentItem = navigationItems.find((item) => item.id === activeTab);
    return currentItem ? currentItem.description : "Welcome to EduAid";
  };
  ...
  return (
    <div className="modern-dashboard">
      ...
      {/* Sidebar */}
      <aside
        className={`modern-sidebar ${sidebarCollapsed ? "collapsed" : ""} ${
          ...
          <div className="profile-avatar">
            <img
              src={
                ...
                )}&background=FF7A00&color=fff&size=80`
              }
              alt="Profile"
            />
      ...
      {/* Main Content */}
      <main
        className={`modern-main ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}
      >
        {/* Header */}
