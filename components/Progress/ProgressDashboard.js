...
const ProgressDashboard = ({ userId }) => {
  ...
  const progressPercentage =
    (progressData.currentWeekHours / progressData.weeklyGoal) * 100;
  ...
  return (
    <div className="progress-dashboard">
      ...
      <div className="progress-section">
        ...
        <p>
          {progressData.currentWeekHours} / {progressData.weeklyGoal} hours
          completed
        </p>
      </div>
      ...
      <div className="charts-container">
        ...
        <div className="chart">
          ...
          <div className="performance-list">
            {Object.entries(progressData.subjectPerformance).map(
              ([subject, score]) => (
